...
class PostByChefController extends ChangeNotifier {
  ...
  void setIdAndFetch(String chefId) {
    _id = chefId;
    fetchData();
  }
  ...
  Future<void> fetchData() async {
    try {
      var response = await http.get(Uri.parse(
          'https://appy.trycatchtech.com/v3/healthy_recipes/healthy_recipes_post_list_by_chef/?chef_id=$_id'));
